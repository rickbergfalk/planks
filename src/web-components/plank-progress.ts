...
/**
 * PlankProgress - a progress bar web component that mirrors shadcn/ui Progress
 *
 * Uses light DOM so Tailwind classes apply directly.
 * Implements ARIA progressbar pattern for accessibility.
 */
@customElement("plank-progress")
export class PlankProgress extends LitElement {
