...
/**
 * HalSeparator - a separator web component that mirrors shadcn/ui Separator
 *
 * Uses light DOM so Tailwind classes apply directly.
 */
@customElement("hal-separator")
export class HalSeparator extends LitElement {
