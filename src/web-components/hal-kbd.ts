...
/**
 * HalKbd - a keyboard key indicator web component that mirrors shadcn/ui Kbd
 *
 ...
 */
@customElement("hal-kbd")
export class HalKbd extends LitElement {
...
/**
 * HalKbdGroup - groups multiple keyboard keys together
 *
 * Uses light DOM so Tailwind classes apply directly.
 ...
 * Pattern: Manual child distribution
 */
@customElement("hal-kbd-group")
export class HalKbdGroup extends LitElement {
  @property({ type: String })
  class: string = ""
