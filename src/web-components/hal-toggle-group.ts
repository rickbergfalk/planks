...
/**
 * HalToggleGroup - Container component that manages toggle group selection state
 *
 ...
 *   <hal-toggle-group-item value="bold">B</hal-toggle-group-item>
 *   <hal-toggle-group-item value="italic">I</hal-toggle-group-item>
 * </hal-toggle-group>
 * ```
 */
@customElement("hal-toggle-group")
export class HalToggleGroup extends LitElement {
  ...
  private _updateChildren() {
    const items = this.querySelectorAll("hal-toggle-group-item")
    const itemsArray = Array.from(items) as HalToggleGroupItem[]
...
/**
 * HalToggleGroupItem - Individual toggle button within a group
 */
@customElement("hal-toggle-group-item")
export class HalToggleGroupItem extends LitElement {
  @property({ type: String, reflect: true }) value = ""
  @property({ type: Boolean, reflect: true }) disabled = false
  ...
  private _handleClick = () => {
    ...
    const group = this.closest("hal-toggle-group") as HalToggleGroup
...
declare global {
  interface HTMLElementTagNameMap {
    "hal-toggle-group": HalToggleGroup
    "hal-toggle-group-item": HalToggleGroupItem
  }
}
