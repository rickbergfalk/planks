...
/**
 * hal-input-group: Container for grouping inputs with addons
 *
 ...
 * ```
 */
@customElement("hal-input-group")
export class HalInputGroup extends LitElement {
...
/**
 * hal-input-group-addon: Addon container for icons, buttons, or text
 *
 ...
 *   <svg>...</svg>
 * </hal-input-group-addon>
 * <hal-input-group-addon align="inline-end">USD</hal-input-group-addon>
 * ```
 */
@customElement("hal-input-group-addon")
export class HalInputGroupAddon extends LitElement {
  ...
  private _handleClick = (e: MouseEvent) => {
    ...
    const group = this.closest("hal-input-group")
...
/**
 * hal-input-group-button: Styled button for use inside input group addons
 *
 * @example
 * ```html
 * <hal-input-group-addon align="inline-end">
 *   <hal-input-group-button>Search</hal-input-group-button>
 * </hal-input-group-addon>
 * ```
 */
@customElement("hal-input-group-button")
export class HalInputGroupButton extends LitElement {
...
/**
 * hal-input-group-text: Text element for use inside input group addons
 *
 * @example
 * ```html
 * <hal-input-group-addon>
 *   <hal-input-group-text>https://</hal-input-group-text>
 * </hal-input-group-addon>
 * ```
 */
@customElement("hal-input-group-text")
export class HalInputGroupText extends LitElement {
  createRenderRoot() {
    return this
  }
...
/**
 * hal-input-group-input: Styled input for use inside input groups
 *
 * @example
 * ```html
 * <hal-input-group>
 ...
 * ```
 */
@customElement("hal-input-group-input")
export class HalInputGroupInput extends LitElement {
...
/**
 * hal-input-group-textarea: Styled textarea for use inside input groups
 *
 * @example
 * ```html
 * <hal-input-group>
 ...
 * ```
 */
@customElement("hal-input-group-textarea")
export class HalInputGroupTextarea extends LitElement {
  @property({ type: String }) placeholder = ""
  @property({ type: String }) value = ""
  @property({ type: String }) name = ""
...
declare global {
  interface HTMLElementTagNameMap {
    "hal-input-group": HalInputGroup
    "hal-input-group-addon": HalInputGroupAddon
    "hal-input-group-button": HalInputGroupButton
    "hal-input-group-text": HalInputGroupText
    "hal-input-group-input": HalInputGroupInput
    "hal-input-group-textarea": HalInputGroupTextarea
  }
}
