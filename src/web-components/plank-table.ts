...
/**
 * PlankTable - A styled table container
 *
 * Wraps content in a scrollable container and a native <table> element.
 * Children must be plank-table-header, plank-table-body, plank-table-footer,
 * or plank-table-caption components.
 */
@customElement("plank-table")
export class PlankTable extends LitElement {
...
/**
 * PlankTableHeader - Table header section (<thead>)
 */
@customElement("plank-table-header")
export class PlankTableHeader extends LitElement {
  @property({ type: String })
  class: string = ""
...
/**
 * PlankTableBody - Table body section (<tbody>)
 */
@customElement("plank-table-body")
export class PlankTableBody extends LitElement {
  @property({ type: String })
  class: string = ""
  ...
  private _setupTbody() {
    ...
    // Use :last-child > tr since tr is inside plank-table-row (with display:contents)
...
/**
 * PlankTableFooter - Table footer section (<tfoot>)
 */
@customElement("plank-table-footer")
export class PlankTableFooter extends LitElement {
  @property({ type: String })
  class: string = ""
  ...
  private _setupTfoot() {
    ...
    // Use :last-child_tr since tr is inside plank-table-row (with display:contents)
...
/**
 * PlankTableRow - Table row (<tr>)
 */
@customElement("plank-table-row")
export class PlankTableRow extends LitElement {
  @property({ type: String })
  class: string = ""
...
/**
 * PlankTableHead - Table header cell (<th>)
 */
@customElement("plank-table-head")
export class PlankTableHead extends LitElement {
  @property({ type: String })
  class: string = ""
...
/**
 * PlankTableCell - Table data cell (<td>)
 */
@customElement("plank-table-cell")
export class PlankTableCell extends LitElement {
  @property({ type: String })
  class: string = ""
...
/**
 * PlankTableCaption - Table caption (<caption>)
 */
@customElement("plank-table-caption")
export class PlankTableCaption extends LitElement {
  @property({ type: String })
  class: string = ""
...
declare global {
  interface HTMLElementTagNameMap {
    "plank-table": PlankTable
    "plank-table-header": PlankTableHeader
    "plank-table-body": PlankTableBody
    "plank-table-footer": PlankTableFooter
    "plank-table-row": PlankTableRow
    "plank-table-head": PlankTableHead
    "plank-table-cell": PlankTableCell
    "plank-table-caption": PlankTableCaption
  }
}
