...
/**
 * HalMenubar - A visually persistent menu common in desktop applications
 *
 ...
 * ```
 */
@customElement("hal-menubar")
export class HalMenubar extends LitElement {
  @property({ type: String }) class: string = ""

  private _menus: HalMenubarMenu[] = []
  ...
  private _collectMenus() {
    this._menus = Array.from(
      this.querySelectorAll(":scope > hal-menubar-menu")
    ) as HalMenubarMenu[]
  ...
  _dispatchSelect(item: HalMenubarItem) {
    this.dispatchEvent(
  ...
  _dispatchCheckedChange(item: HalMenubarCheckboxItem, checked: boolean) {
    this.dispatchEvent(
  ...
  _dispatchValueChange(group: HalMenubarRadioGroup, value: string) {
    this.dispatchEvent(
...
/**
 * HalMenubarMenu - Container for a single menu within the menubar
 */
@customElement("hal-menubar-menu")
export class HalMenubarMenu extends LitElement {
  @state() private _isMenuOpen = false

  private _menubar: HalMenubar | null = null
  private _menuIndex: number = 0
  private _trigger: HalMenubarTrigger | null = null
  private _content: HalMenubarContent | null = null
  private _contentId = `hal-menubar-content-${++menubarId}`
  ...
  firstUpdated() {
    this._trigger = this.querySelector(
      "hal-menubar-trigger"
    ) as HalMenubarTrigger | null
    this._content = this.querySelector(
      "hal-menubar-content"
    ) as HalMenubarContent | null
  ...
  _setMenubar(menubar: HalMenubar, index: number) {
...
/**
 * HalMenubarTrigger - The button that opens a menubar menu
 */
@customElement("hal-menubar-trigger")
export class HalMenubarTrigger extends LitElement {
  @property({ type: String }) class: string = ""

  private _menu: HalMenubarMenu | null = null
...
/**
 * HalMenubarContent - The dropdown content for a menubar menu
 */
@customElement("hal-menubar-content")
export class HalMenubarContent extends LitElement {
  ...
  private _collectItems() {
    this._items = Array.from(
      this.querySelectorAll(
        "hal-menubar-item:not([disabled]), hal-menubar-checkbox-item:not([disabled]), hal-menubar-radio-item:not([disabled]), hal-menubar-sub-trigger:not([disabled])"
      )
    ) as HTMLElement[]
  }
    ...
    switch (e.key) {
      ...
      case "ArrowRight": {
        ...
        if (focusedItem?.tagName === "PLANK-MENUBAR-SUB-TRIGGER") {
          ;(focusedItem as HalMenubarSubTrigger)._openSub()
        } else {
          menubar?._handleArrowNavigation("right")
        }
        break
...
/**
 * HalMenubarItem - A menu item within a menubar menu
 */
@customElement("hal-menubar-item")
export class HalMenubarItem extends LitElement {
  ...
  private _handleClick = () => {
    ...
    // Find parent menubar
    const menubar = this.closest("hal-menubar") as HalMenubar | null
...
/**
 * HalMenubarCheckboxItem - A checkbox item within a menubar menu
 */
@customElement("hal-menubar-checkbox-item")
export class HalMenubarCheckboxItem extends LitElement {
...
/**
 * HalMenubarRadioGroup - A radio group within a menubar menu
 */
@customElement("hal-menubar-radio-group")
export class HalMenubarRadioGroup extends LitElement {
  ...
  private _updateItems() {
    const items = this.querySelectorAll(
      "hal-menubar-radio-item"
    ) as NodeListOf<HalMenubarRadioItem>
    items.forEach((item) => {
      item._setGroup(this)
...
/**
 * HalMenubarRadioItem - A radio item within a menubar radio group
 */
@customElement("hal-menubar-radio-item")
export class HalMenubarRadioItem extends LitElement {
  @property({ type: String }) value = ""
  @property({ type: Boolean }) disabled = false
  @property({ type: String }) class: string = ""
  ...
  private _group: HalMenubarRadioGroup | null = null
  ...
  _setGroup(group: HalMenubarRadioGroup) {
    this._group = group
  }
...
/**
 * HalMenubarLabel - A label within a menubar menu
 */
@customElement("hal-menubar-label")
export class HalMenubarLabel extends LitElement {
  @property({ type: Boolean }) inset = false
  @property({ type: String }) class: string = ""
...
/**
 * HalMenubarSeparator - A separator line within a menubar menu
 */
@customElement("hal-menubar-separator")
export class HalMenubarSeparator extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * HalMenubarShortcut - A keyboard shortcut indicator
 */
@customElement("hal-menubar-shortcut")
export class HalMenubarShortcut extends LitElement {
  @property({ type: String }) class: string = ""
...
/**
 * HalMenubarGroup - A group of items within a menubar menu
 */
@customElement("hal-menubar-group")
export class HalMenubarGroup extends LitElement {
  createRenderRoot() {
    return this
  }
...
/**
 * HalMenubarSub - A submenu container
 */
@customElement("hal-menubar-sub")
export class HalMenubarSub extends LitElement {
  @state() private _isSubOpen = false

  private _trigger: HalMenubarSubTrigger | null = null
  private _content: HalMenubarSubContent | null = null
  ...
  firstUpdated() {
    this._trigger = this.querySelector(
      "hal-menubar-sub-trigger"
    ) as HalMenubarSubTrigger | null
    this._content = this.querySelector(
      "hal-menubar-sub-content"
    ) as HalMenubarSubContent | null
...
/**
 * HalMenubarSubTrigger - The trigger for a submenu
 */
@customElement("hal-menubar-sub-trigger")
export class HalMenubarSubTrigger extends LitElement {
  @property({ type: Boolean }) inset = false
  @property({ type: Boolean }) disabled = false
  @property({ type: String }) class: string = ""

  private _sub: HalMenubarSub | null = null
...
/**
 * HalMenubarSubContent - The content for a submenu
 */
@customElement("hal-menubar-sub-content")
export class HalMenubarSubContent extends LitElement {
  @property({ type: String }) class: string = ""
...
declare global {
  interface HTMLElementTagNameMap {
    "hal-menubar": HalMenubar
    "hal-menubar-menu": HalMenubarMenu
    "hal-menubar-trigger": HalMenubarTrigger
    "hal-menubar-content": HalMenubarContent
    "hal-menubar-item": HalMenubarItem
    "hal-menubar-checkbox-item": HalMenubarCheckboxItem
    "hal-menubar-radio-group": HalMenubarRadioGroup
    "hal-menubar-radio-item": HalMenubarRadioItem
    "hal-menubar-label": HalMenubarLabel
    "hal-menubar-separator": HalMenubarSeparator
    "hal-menubar-shortcut": HalMenubarShortcut
    "hal-menubar-group": HalMenubarGroup
    "hal-menubar-sub": HalMenubarSub
    "hal-menubar-sub-trigger": HalMenubarSubTrigger
    "hal-menubar-sub-content": HalMenubarSubContent
  }
}
