...
// Global toast state
let toasterInstance: HalToaster | null = null
...
/**
 * hal-toaster: Container for toast notifications
 * Place this once at the root of your app
 */
@customElement("hal-toaster")
export class HalToaster extends LitElement {
