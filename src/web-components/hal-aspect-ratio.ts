...
/**
 * HalAspectRatio - maintains a desired aspect ratio for content
 *
 * Uses light DOM so Tailwind classes apply directly.
 * Uses CSS aspect-ratio property for modern browser support.
 */
@customElement("hal-aspect-ratio")
export class HalAspectRatio extends LitElement {
  /**
...
declare global {
  interface HTMLElementTagNameMap {
    "hal-aspect-ratio": HalAspectRatio
  }
}
