...
/**
 * PlankCheckbox - a checkbox web component that mirrors shadcn/ui Checkbox
 *
 ...
 */
@customElement("plank-checkbox")
export class PlankCheckbox extends LitElement {
