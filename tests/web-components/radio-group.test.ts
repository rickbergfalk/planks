...
import type {
  HalRadioGroup,
  HalRadioGroupItem,
} from "../../src/web-components/hal-radio-group"

describe("hal-radio-group", () => {
  ...
  describe("HalRadioGroup", () => {
    it("renders with data-slot attribute", async () => {
      container.innerHTML = `<hal-radio-group></hal-radio-group>`
      await customElements.whenDefined("hal-radio-group")
      const el = container.querySelector("hal-radio-group")!
      await (el as HalRadioGroup).updateComplete
    ...
    it("defaults to no value", async () => {
      container.innerHTML = `<hal-radio-group></hal-radio-group>`
      await customElements.whenDefined("hal-radio-group")
      const el = container.querySelector("hal-radio-group") as HalRadioGroup
      await el.updateComplete
      expect(el.value).toBe("")
    })

    it("can be initialized with value attribute", async () => {
      container.innerHTML = `<hal-radio-group value="option1"></hal-radio-group>`
      await customElements.whenDefined("hal-radio-group")
      const el = container.querySelector("hal-radio-group") as HalRadioGroup
      await el.updateComplete
    ...
    it("applies custom class", async () => {
      container.innerHTML = `<hal-radio-group class="custom-class"></hal-radio-group>`
      await customElements.whenDefined("hal-radio-group")
      const el = container.querySelector("hal-radio-group") as HalRadioGroup
      await el.updateComplete
  ...
  describe("HalRadioGroupItem", () => {
    it("renders with data-slot attribute", async () => {
      container.innerHTML = `
        <hal-radio-group>
          <hal-radio-group-item value="option1"></hal-radio-group-item>
        </hal-radio-group>
      `
      await customElements.whenDefined("hal-radio-group")
      ...
      const item = container.querySelector(
        "hal-radio-group-item"
      ) as HalRadioGroupItem
    ...
    it("has tabindex=-1 when not checked (and not first)", async () => {
      container.innerHTML = `
        <hal-radio-group value="option2">
          <hal-radio-group-item value="option1"></hal-radio-group-item>
          <hal-radio-group-item value="option2"></hal-radio-group-item>
        </hal-radio-group>
      `
      await customElements.whenDefined("hal-radio-group")
      const group = container.querySelector("hal-radio-group") as HalRadioGroup
      await group.updateComplete
      const items = container.querySelectorAll("hal-radio-group-item")
      await (items[0] as HalRadioGroupItem).updateComplete
    ...
    it("selects on click", async () => {
      ...
      ;(items[1] as HalRadioGroupItem).click()
      await group.updateComplete
    ...
    it("does not select when disabled", async () => {
      container.innerHTML = `
        <hal-radio-group value="option1">
          <hal-radio-group-item value="option1"></hal-radio-group-item>
          <hal-radio-group-item value="option2" disabled></hal-radio-group-item>
        </hal-radio-group>
      `
      await customElements.whenDefined("hal-radio-group")
      const group = container.querySelector("hal-radio-group") as HalRadioGroup
    ...
    it("skips disabled items when navigating with arrow keys", async () => {
      container.innerHTML = `
        <hal-radio-group value="option1">
          <hal-radio-group-item value="option1"></hal-radio-group-item>
          <hal-radio-group-item value="option2" disabled></hal-radio-group-item>
          <hal-radio-group-item value="option3"></hal-radio-group-item>
        </hal-radio-group>
      `
      await customElements.whenDefined("hal-radio-group")
      const group = container.querySelector("hal-radio-group") as HalRadioGroup
  ...
  describe("Events", () => {
    ...
    it("does not fire event when clicking already selected item", async () => {
      ...
      ;(items[0] as HalRadioGroupItem).click()
      await group.updateComplete
